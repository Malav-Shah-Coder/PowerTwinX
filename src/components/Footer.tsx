    ...
    <footer className="relative z-10 border-t border-border bg-background pt-20 pb-10">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-5 gap-10 mb-16">
        <div className="col-span-2 md:col-span-2">
          <span className="font-display text-2xl text-foreground mb-4 block">PowerTwinX</span>
      ...
      <div className="border-t border-border/50 max-w-6xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between text-xs text-muted-foreground gap-4">
